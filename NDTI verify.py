...
if __name__ == "__main__":
    try:
        ...
        print("📍 Region: Czech Republic (Brno Area)")
        print("📅 Time Period: July 2020")
        ...
        if result:
            ...
            print("   • Analyzed specific bounding box in Czech Republic")
            print("   • Time period set to July 1-31, 2020")
