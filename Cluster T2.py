...
class PhenologyProcessor:
    ...
    def Pull_Process_Sentinel_data(self, QA_BAND='cs_cdf', CLEAR_THRESHOLD=0.65):
        ...
        try:
            ...
            # Calculate NDTI
            ndti_collection = ndvi_collection.map(calculate_ndti)
            
            # Add MJD
            final_collection = ndti_collection.map(add_modified_julian_date)
